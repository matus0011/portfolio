  ...
  var Wcf_User_Guilder = {
    init: function (settings) {
      ...
      Wcf_User_Guilder.config = {
        ...
        banner_link:
          "https://www.treethemes.com/assets/wp-content/uploads/2024/07/theme-preview.png",
        ...
        has_update: false,
        license_form_heading: 'Unlock Full Access',
        license_form_desc: 'Activate your license to enable all features, receive updates, and access premium support.',
        license_note: 'We’ll send product updates to this email address. We won’t spam you.',
        license_instruction: [
		    'How to find your license key → <a href="https://docs.treethemes.com/brandberry/docs/getting-started/theme-installation-and-license-activation/#find-envato-license" target="_blank">View documentation</a>'

        ],
        welcome_heading: "Welcome to Brandberry 1.0",
        welcome_desc:
          "Brandberry is a versatile, responsive, and beautifully crafted theme designed to be accessible and user-friendly. Built with Elementor, it includes seven stunning ready-made websites to get you started quickly.",
        _required_plugins: [
          {
            slug: "elementor",
            title: "Elementor",
          ...
          },
          {
            ...
            title: "Animation Addon for Elementor",
            "remote-source": true,
          },
          {
            slug: "animation-addons-for-elementor-pro",
            title: "Animation Addons for Elementor Pro",
            "remote-source": false,
          },
          {
            slug: "brandberry-essential",
            title: "Brandberry Essential",
            "remote-source": false,
          },
          {
            slug: "contact-form-7",
        ...
        loader_icon:
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><rect fill="#CEFF39" stroke="#CEFF39" stroke-width="11" width="30" height="30" x="25" y="85"><animate attributeName="opacity" calcMode="spline" dur="1.5" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.4"></animate></rect><rect fill="#CEFF39" stroke="#CEFF39" stroke-width="11" width="30" height="30" x="85" y="85"><animate attributeName="opacity" calcMode="spline" dur="1.5" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.2"></animate></rect><rect fill="#CEFF39" stroke="#CEFF39" stroke-width="11" width="30" height="30" x="145" y="85"><animate attributeName="opacity" calcMode="spline" dur="1.5" values="1;0;1;" keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="0"></animate></rect></svg>',
      };

      ajax_object.required_plugins.forEach(element => {
        // check if slug already exists in the array
        const exists = Wcf_User_Guilder.config._required_plugins.some(
          item => item.slug === element.slug
        );

        if (!exists) {
          Wcf_User_Guilder.config._required_plugins.push(element);
        }

      });


      Wcf_User_Guilder.config.footer_link = ajax_object.footer_link;
      Wcf_User_Guilder.config.welcome_heading = ajax_object.welcome_heading;
      Wcf_User_Guilder.config.welcome_desc = ajax_object.welcome_desc;
      Wcf_User_Guilder.config.rating_link = ajax_object.rating_link;

      if (ajax_object?.license_instruction) {
        Wcf_User_Guilder.config.license_instruction = ajax_object.license_instruction;
      }

      if (ajax_object?.license_form_heading) {
        Wcf_User_Guilder.config.license_form_heading = ajax_object.license_form_heading;
      }

      if (ajax_object?.license_form_desc) {
        Wcf_User_Guilder.config.license_form_desc = ajax_object.license_form_desc;
      }

      if (ajax_object.banner_link && ajax_object.banner_link != '') {
        Wcf_User_Guilder.config.banner_link = ajax_object.banner_link;
      }

      if (ajax_object?.license_note && ajax_object.license_note != '') {
        Wcf_User_Guilder.config.license_note = ajax_object.license_note;
      }
    ...
    createContainer: function () {
      const $footer_content = `
           <style>
            ...
            .wcf-info-ug-modal #wcf-theme-update-info ul li{
                color: #fff;
                opacity:0.8;
                margin:0;
            }
            ...
            .wcf--license-default-btn.deactivate{background:#3e4146;}
            
            .wcf--license-default-btn:active,
            .wcf--license-default-btn:focus{
	         	color:#fff;
	         	border:none;
	         	box-shadow:none;   
	        }
            ...
            .wcf-license-step-one input.code:focus {
                background: #eff1f5;
			...
			.wcf-license-step-two .list li svg{
				background: #1dcb78;
			    height: 10px;
			    width: 10px;
			    border-radius: 100%;
			...
			.wcf-license-step-two .list li path{
			    fill:#fff;
			}
            ...
            .wcf-user-guider-dashboard p,
            .wcf-user-guider-dashboard h1,
            .wcf-user-guider-dashboard h2,
            .wcf-user-guider-dashboard h3,
            .wcf-user-guider-dashboard h4,
            .wcf-user-guider-dashboard h5,
            .wcf-user-guider-dashboard h6,
            .wcf-user-guider-dashboard label,
            .wcf-user-guider-dashboard input,
            .wcf-user-guider-dashboard li,
            .wcf-user-guider-dashboard a{
	            font-family: Helvetica Neue, Arial, san-serif;
	        }
                  ...
                  <span class="wcf-info-ug-close">&times;</span>
                    ...
                    <div class="wcf-flex-area">
                        <div class="wcf-info--card">
                            ...
                            <p>Cut your learning curve and get started with Brandberry in no time! Read our well-structured docs.</p>
                            <a href="${Wcf_User_Guilder.config.footer_link.documentation_link}" target="_blank" class="wcf--license-default-btn">Learn more</a>
                        </div>
                        <div class="wcf-info--card">
                            <div class="icon">
                            <svg width="42" height="42" viewBox="0 0 42 42" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="${Wcf_User_Guilder.config.footer_link.support_link}" target="_blank" class="wcf--license-default-btn">Get support</a>
                        </div>
                         ...
                         <div class="wcf-info--card">
                            ...
                            <p>Discover more premium WordPress themes and resources on our website.</p>
                            <a href="https://treethemes.com" target="_blank" class="wcf--license-default-btn">Visit Our Website</a>
                        </div>
      ...
      if (Wcf_User_Guilder.config.location != "") {
        $(Wcf_User_Guilder.config.location).append(
          $("<div/>", {
    ...
    register_event_listners: function () {
      ...
      $(document).on("click", ".wcf--license-activation-button", function () {
        ...
        if (
          Wcf_User_Guilder.isEmail(ls_email.val()) &&
          ls_code.val().length > 5
        ) {
      ...
      $(document).on("click", "#wcf--deactivate-ls", function (e) {
...
*/
    ...
    plugin_status_update: function (user_action) {
      if (user_action) {
        $(".wcf--plugins-install-button").html(
          $(".wcf--plugins-install-button").html() +
          Wcf_User_Guilder.config.loader_icon
        );
        Wcf_User_Guilder.config.current_g_activitiy = true;
      }
      ...
      jQuery.ajax({
        ...
        success: function (response) {
          ...
          if (
            response.hasOwnProperty("installable_plugins") &&
            response.installable_plugins.length === 0
          ) {
    ...
    goto_thankyou_page: function (path) {
      ...
      if (Wcf_User_Guilder.config.current_g_activitiy) {
        thanks = `<h3>Theme Activated Successfully! 🎉 </h3>
                <p>You can now import a demo layout to get started faster and customize it to fit your needs.</p>`;
      } else {
        thanks = `<h3>You’re All Set! 🎉 </h3>
                <p>You can now import a demo layout to get started faster and customize it to fit your needs.</p>`;
      }
      ...
      let plugins_html = `
            <div class="wcf--license-step-three">
                ...
                <div class="rating-wrap">
                    ...
                    <svg width="17" height="16" viewBox="0 0 27 26" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.5 0L17.8386 8.32612L27 9.93112L20.52 16.6819L21.8435 26L13.5 21.8461L5.15654 26L6.48 16.6819L0 9.93112L9.1614 8.32612L13.5 0Z"/>
                         ...
                         <svg width="17" height="16" viewBox="0 0 27 26" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.5 0L17.8386 8.32612L27 9.93112L20.52 16.6819L21.8435 26L13.5 21.8461L5.15654 26L6.48 16.6819L0 9.93112L9.1614 8.32612L13.5 0Z"/>
                        </svg> <svg width="17" height="16" viewBox="0 0 27 26" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.5 0L17.8386 8.32612L27 9.93112L20.52 16.6819L21.8435 26L13.5 21.8461L5.15654 26L6.48 16.6819L0 9.93112L9.1614 8.32612L13.5 0Z"/>
                        </svg> <svg width="17" height="16" viewBox="0 0 27 26" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.5 0L17.8386 8.32612L27 9.93112L20.52 16.6819L21.8435 26L13.5 21.8461L5.15654 26L6.48 16.6819L0 9.93112L9.1614 8.32612L13.5 0Z"/>
                        </svg> <svg width="17" height="16" viewBox="0 0 27 26" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <h3>Help Us Grow</h3>
                    <p>Loving our theme? Please consider giving us a <b>5-star</b> rating, it helps support our ongoing development!</p>
                    <a href="${Wcf_User_Guilder.config.rating_link}" target="_blank" class="wcf--license-default-btn rating">Give a rating</a>
                </div>
            </div>
            `;
    ...
    check_license_activation: function (action = false, actiondata = false) {
      ...
      let data = {
        action: "the_user_guide_ls_checker",
        nonce: ajax_object.ajax_nonce,
      ...
      jQuery.ajax({
        ...
        success: function (response) {
          ...
          if ("next_step" in response?.data) {
            if (response.data.next_step == "final_license_check") {
          ...
          if (response?.data?.license !== "valid") {
            let form = `
                            <div class="wcf-license-step-one">
                                <h3>${Wcf_User_Guilder.config.license_form_heading}</h3>
                                <p>${Wcf_User_Guilder.config.license_form_desc}</p>
                                <div style="text-align:center; padding-bottom: 10px; color: #f16060;font-family: Helvetica Neue, Arial, san-serif;"><b class="wcf-warning-message">${msgs}</b> </div>
                                ...
                                <div class="el-license-field">
                                    ...
                                    <input type="text" class="regular-text code" name="el_license_email" size="50" value="${response?.data?.email}" placeholder="yoyo@gmail.com"required="required">
                                </div>
                                <div class="el-license-field">
                                    <label></label>                                
                                    <p>${Wcf_User_Guilder.config.license_note}</p>
                                </div>
                                ...
                                <div class="theme-license-steps">
                                    <ul class="list">
                                     ${Wcf_User_Guilder.config.license_instruction.map(step => `<li>${step}</li>`).join('')}
                                    </ul>
                                </div>
                            </div>    
                        `;
