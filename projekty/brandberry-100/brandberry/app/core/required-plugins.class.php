...
class Required_Plugins
{
    ...
    public function wcf_user_guide_plugins_install()
    {
        ...
        if (isset($return['all_active']) && $return['all_active'] == true) {
            $return['demo_path'] = apply_filters('brandberry_theme_demo_path', admin_url("admin.php?page=the-theme-demo-importer"));
        }
    ...
    public function get_plugin_config_data()
    {
        ...
        $plugins     = array(
            array(
                'name'         => esc_html__('Elementor', 'brandberry'),
                'slug'         => 'elementor',
                'required'     => true,
            ),
            array(
                'name'         => esc_html__('Contact form 7', 'brandberry'),
                'slug'         => 'contact-form-7',
                'required'     => true,
            ),
            
            array(
                'name'         => esc_html__('SVG Support', 'brandberry'),
                'slug'         => 'svg-support',
                'required'     => true,
            ),
            
            array(
                'name'         => esc_html__('Brandberry Essential', 'brandberry'),               
            ...
            array(
                'name'         => esc_html__('Animation Addons For Elementor', 'brandberry'),
                'slug'         => 'animation-addons-for-elementor',
                'required'     => true,               
            ),

            array(
                'name'         => esc_html__('Animation Addons for Elementor Pro', 'brandberry'),
                'slug'         => 'animation-addons-for-elementor-pro',
                'required'     => false,
                'version'       => '2.6.0',
                'source'     => BRANDBERRY_THEME_DIR . '/app/third-party/animation-addons-for-elementor-pro.zip', // The plugin source.
            ),

        );

        return apply_filters('wcf_theme_required_plugins', $plugins);
    }
    ...
    public function register_required_plugins()
    {
        ...
        $config = array(
            'id'             => 'brandberry', // Unique ID for hashing notices for multiple instances of TGMPA.
            'default_path'     => '', // Default absolute path to bundled plugins.
            'menu'             => 'brandberry-install-plugins', // Menu slug.
