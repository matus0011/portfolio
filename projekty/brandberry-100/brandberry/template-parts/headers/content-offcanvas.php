  <?php
   ...
   $offcanvas_logo           = brandberry_option( 'offcanvas_logo' , $light_logo );
   $offcanvas_content        = brandberry_option( 'offcanvas_content' );
   $offcanvas_gallery_enable = brandberry_option( 'offcanvas_gallery_enable' );
    
   $offcanvas_gallery        = brandberry_option( 'offcanvas_gallery' );
   $offcanvas_gallery_title  = brandberry_option( 'offcanvas_gallery_title' );
   $social_link              = brandberry_option( 'social_link' );
   $offcanvas_social_heading = brandberry_option( 'offcanvas_social_heading' );
   $offcanvas_social         = brandberry_option( 'offcanvas_social' );
      ...
      <div class="offcanvas__body">
        <div class="offcanvas__logo">
          <?php  if($offcanvas_logo): ?> 
            <a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url($offcanvas_logo); ?>" alt="<?php echo esc_attr__('Offcanvas Logo','brandberry') ?>"></a>
          <?php endif; ?>
        ...
        <div class="offcanvas__menu-area">
          ...
          <nav class="brandberry-mb-mobile-menu" aria-label="<?php esc_attr_e( 'Mobile menu', 'helo' ); ?>">
        ...
        <div class="offcanvas__gallery">
          ...
          <div class="gallery__items">
            ...
            <div class="gallery__item">
              <a href="<?php echo esc_url($gallery_item['url']); ?>"><img src="<?php echo esc_url($gallery_item['image']['thumbnail']); ?>" alt="<?php echo esc_attr__('gallery Image','brandberry'); ?>">
