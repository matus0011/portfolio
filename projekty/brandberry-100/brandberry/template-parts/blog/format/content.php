<?php
   ...
   $blog_readmore__icon = BRANDBERRY_IMG .'/default-blog/icon-right-arrow.svg';
  ...
  <article <?php post_class('default-blog__item-single'); ?>>
    ...
    <div class="default-blog__content">
      <?php echo brandberry_post_meta(); ?>
        ...
        <?php if(brandberry_option('blog_readmore',1)): ?>
          <div class="cf_btn">
            <a href="<?php the_permalink(); ?>" class="wc-btn-underline"><span class="scr_only"><?php echo esc_html('Blog details page button'); ?></span> <?php echo esc_html(brandberry_option('blog_readmore_text','Read more')); ?><?php echo brandberry_kses($icon); ?></a>
          </div>
        <?php endif; ?>
    </div>
  </article>
