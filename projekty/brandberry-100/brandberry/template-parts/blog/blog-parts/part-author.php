<?php
   ...
   $blog_author             = brandberry_option( 'blog_single_author_box' , 0 ); 
   $user_id                 = get_the_author_meta( 'ID' );
   $brandberry_profile_options    = get_user_meta( get_the_author_meta( 'ID' ) , 'brandberry_profile_options', true );
   $social                  = isset( $brandberry_profile_options[ 'social_share' ] ) ? $brandberry_profile_options[ 'social_share' ]:'';
