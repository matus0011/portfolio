...
namespace BrandBerry\TemplateLibrary;
...
final class Elementor_Template_Loader
{
    ...
    public static function include(){
		include_once(BRANDBERRY_ESSENTIAL_DIR_PATH.'inc/packages/ele-template-library/base/library-source.php');
		include_once(BRANDBERRY_ESSENTIAL_DIR_PATH.'inc/packages/ele-template-library/base/Templates_Lib.php');
