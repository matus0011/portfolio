...
class WC_Cart_Count extends \Elementor\Widget_Base {
	...
	public function register_content_controls(){
		...
		$this->add_control(
			'cart_text',
			[
				'label' => esc_html__( 'Cart Content', 'brandberry-essential' ),
	...
	public function register_style_controls(){
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Container', 'brandberry-essential' ),
            ...
            $this->start_controls_tabs( 'icon' );
                ...
                $this->start_controls_tab( 'icon_normal',
                    ...
                    $this->add_control(
                        'iconmargin',
                        [
                            'label' => esc_html__( 'Margin', 'brandberry-essential' ),
                            'type' => \Elementor\Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px', '%', 'em', 'rem' ],
                            'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Cart Count', 'brandberry-essential' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );	
                ...
                $this->start_controls_tab( 'count_normal',
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'label_off' => esc_html__( 'Default', 'brandberry-essential' ),
                    ...
                    $this->add_responsive_control(
                        'popover_pos_left',
                        [
                            'label' => esc_html__( 'Left', 'brandberry-essential' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%', 'em', 'rem' ],
                            'range' => [
                                'px' => [
                    ...
                    $this->add_responsive_control(
                        'popover_pos_top',
                        [
                            'label' => esc_html__( 'Top', 'brandberry-essential' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px', '%', 'em', 'rem' ],
                            'range' => [
                                'px' => [
	...
	protected function render() {
	    ...
	    // Add class first
	    $this->add_render_attribute( 'cart_link', 'class', 'position-relative' );
	
	    // Build URL (fallback to cart page)
	    $link = $settings['cart_link'] ?? [];
	    $url  = ! empty( $link['url'] ) ? $link['url'] : wc_get_cart_url();
	
	    // Always add href
	    $this->add_render_attribute( 'cart_link', 'href', esc_url( $url ) );
	
	    // Apply Elementor URL options (optional)
	    if ( ! empty( $link['is_external'] ) ) {
	        $this->add_render_attribute( 'cart_link', 'target', '_blank' );
	    }
	    if ( ! empty( $link['nofollow'] ) ) {
	        $this->add_render_attribute( 'cart_link', 'rel', 'nofollow' );
	    }
