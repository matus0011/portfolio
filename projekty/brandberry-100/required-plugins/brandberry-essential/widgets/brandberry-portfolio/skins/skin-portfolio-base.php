...
abstract class Skin_Portfolio_Base extends Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'elementor/element/bb--portfolio/section_layout/after_section_end', [ $this, 'register_controls' ] ,20);
	}
	...
	protected function register_date_controls() {
		...
		$this->start_controls_section(
			'section_date_style',
			[
				'label' => esc_html__( 'Date', 'brandberry' ),
	...
	protected function register_meta_controls() {
		...
		$this->start_controls_section(
			'section_meta',
			[
				'label' => esc_html__( 'Meta', 'brandberry' ),
			]
		);
		...
		$this->add_control(
			'post_taxonomy',
			[
				'label'       => esc_html__( 'Taxonomy', 'brandberry' ),
	...
	protected function register_slider_controls( $default_value = [] ) {
		...
		$this->add_responsive_control(
			'slides_to_show',
			[
				'label'       => esc_html__( 'Slides to Show', 'brandberry' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => $default['slides_to_show'],
				'required'    => true,
				'options'     => [
					                 'auto' => esc_html__( 'Auto', 'brandberry' ),
				                 ] + $slides_to_show,
				'render_type' => 'template',
				'selectors'   => [
					'{{WRAPPER}} .bb__slider' => '--slides-to-show: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			'autoplay',
			[
				'label'   => esc_html__( 'Autoplay', 'brandberry' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $default['autoplay'],
				'options' => [
					'yes' => esc_html__( 'Yes', 'brandberry' ),
					'no'  => esc_html__( 'No', 'brandberry' ),
				],
			]
		);
		...
		$this->add_control(
			'autoplay_delay',
			[
				'label'     => esc_html__( 'Autoplay delay', 'brandberry' ),
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Autoplay Interaction', 'brandberry' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => $default['autoplay_interaction'],
				'options'   => [
					'true'  => esc_html__( 'Yes', 'brandberry' ),
					'false' => esc_html__( 'No', 'brandberry' ),
				],
				'condition' => [
					'autoplay' => 'yes',
				],
		...
		$this->add_control(
			'allow_touch_move',
			[
				'label'     => esc_html__( 'Allow Touch Move', 'brandberry' ),
				'type'      => Controls_Manager::SELECT,
				'separator' => 'before',
		...
		$this->add_control(
			'loop',
			[
				'label'   => esc_html__( 'Loop', 'brandberry' ),
				'type'    => Controls_Manager::SELECT,
		...
		$this->add_control(
			'mousewheel',
			[
				'label'       => esc_html__( 'Mousewheel', 'brandberry' ),
				'description' => esc_html__( 'If you want to use mousewheel, please disable loop.', 'brandberry' ),
		...
		$this->add_control(
			'speed',
			[
				'label'   => esc_html__( 'Animation Speed', 'brandberry' ),
				'type'    => Controls_Manager::NUMBER,
		...
		$this->add_control(
			'space_between',
			[
				'label'       => esc_html__( 'Space Between', 'brandberry' ),
				'type'        => Controls_Manager::NUMBER,
				'default'     => $default['space_between'],
				'render_type' => 'template',
				'selectors'   => [
					'{{WRAPPER}} .bb__slider' => '--space-between: {{VALUE}}px;',
				],
			]
		);
		...
		$this->add_control(
			'effect',
			[
				'label'   => esc_html__( 'Effect', 'brandberry' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $default['effect'],
				'options' => [
					'slide'  => esc_html__( 'Slide', 'brandberry' ),
					'fade'  => esc_html__( 'Fade', 'brandberry' ),
					'coverflow' => esc_html__( 'Coverflow', 'brandberry' ),
					'flip' => esc_html__( 'Flip', 'brandberry' ),
					'cube' => esc_html__( 'Cube', 'brandberry' ),
				],
			]
		);
		...
		$this->add_control(
			'navigation',
			[
				'label'     => esc_html__( 'Navigation', 'brandberry' ),
				'type'      => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'label_on'  => esc_html__( 'Show', 'brandberry' ),
				'label_off' => esc_html__( 'Hide', 'brandberry' ),
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__( 'Previous Arrow Icon', 'brandberry' ),
		...
		$this->add_control(
			...
			[
				'label'            => esc_html__( 'Next Arrow Icon', 'brandberry' ),
				'type'             => Controls_Manager::ICONS,
				'fa4compatibility' => 'icon',
				'skin'             => 'inline',
				'label_block'      => false,
		...
		$this->add_control(
			'pagination',
			[
				'label'     => esc_html__( 'Pagination', 'brandberry' ),
				'type'      => Controls_Manager::SWITCHER,
				'separator' => 'before',
				'label_on'  => esc_html__( 'Show', 'brandberry' ),
				'label_off' => esc_html__( 'Hide', 'brandberry' ),
		...
		$this->add_control(
			'pagination_type',
			[
				'label'     => esc_html__( 'Pagination Type', 'brandberry' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => $default['pagination_type'],
				'options'   => [
					'bullets'     => esc_html__( 'Bullets', 'brandberry' ),
					'fraction'    => esc_html__( 'Fraction', 'brandberry' ),
					'progressbar' => esc_html__( 'Progressbar', 'brandberry' ),
				],
				'condition'        => [
		...
		$this->add_control(
			'direction',
			[
				'label'     => esc_html__( 'Direction', 'brandberry' ),
				'type'      => Controls_Manager::SELECT,
				'separator' => 'before',
				'default'   => $default['direction'],
				'options'   => [
					'ltr' => esc_html__( 'Left', 'brandberry' ),
					'rtl' => esc_html__( 'Right', 'brandberry' ),
				],
			]
		);
	}
	...
	protected function register_slider_pagination_style_controls( $default_selectors = [] ) {
		...
		$this->add_control(
			'bullets_size',
			[
				'label'     => esc_html__( 'Size', 'brandberry' ),
		...
		$this->add_control(
			'bullets_color',
			[
				'label'     => esc_html__( 'Active Color', 'brandberry' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'fraction_current_color',
			[
				'label'     => esc_html__( 'Current Color', 'brandberry' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'fraction_total_color',
			[
				'label'     => esc_html__( 'Total Color', 'brandberry' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'fraction_midline_color',
			[
				'label'     => esc_html__( 'Mid Line Color', 'brandberry' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'progress_color',
			[
				'label'     => esc_html__( 'Progressbar Color', 'brandberry' ),
				'type'      => Controls_Manager::COLOR,
		...
		$this->add_control(
			'progress_fill_color',
			[
				'label'     => esc_html__( 'Progressbar Fill Color', 'brandberry' ),
				'type'      => Controls_Manager::COLOR,
	...
	protected function register_slider_navigation_style_controls( $default_selectors = [] ) {
		...
		$this->add_control(
			...
			[
				'label'     => esc_html__( 'Border Color', 'brandberry' ),
				'type'      => Controls_Manager::COLOR,
	...
	protected function get_slider_attributes( ) {
		...
		if ( ! empty( $this->get_instance_value('navigation') ) ) {
			$slider_settings['navigation'] = [
				'nextEl' => '.elementor-element-' . $this->parent->get_id() . ' .bb-arrow-next',
				'prevEl' => '.elementor-element-' . $this->parent->get_id() . ' .bb-arrow-prev',
			];
		}
	...
	protected function render_slider_navigation() {
        ...
        <div class="ts-navigation">
            <div class="wcf-arrow bb-arrow-prev" role="button" tabindex="0">
				<?php $this->render_swiper_button( 'previous' ); ?>
            </div>
            <div class="wcf-arrow bb-arrow-next" role="button" tabindex="0">
