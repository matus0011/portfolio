document.addEventListener('DOMContentLoaded', function () {
    ...
    if (heading) {
        ...
        btn.href = BRANDBERRY_PAGE_IMPORT.page_url;
        btn.style.top = "0";
        btn.style.left = "5px";
        ...
        btn.innerHTML = `
                <div style="display: flex; 
                    ...
                    align-items: center; 
                    gap: 6px; 
                "><img src="${BRANDBERRY_PAGE_IMPORT.logo}" /> <span style="font-size: 12px; font-weight: 500; color: #FFFFFF">import page</span></div>
                `;
        heading.after(btn);
    }
});