...
module.exports = {
  darkMode: ["class"],
  content: [
    "src/modules/starter-template/layouts/**/*.{js,jsx}",
    "src/modules/starter-template/components/**/*.{js,jsx}",
    "src/modules/starter-template/pages/**/*.{js,jsx}",
  ],
  prefix: "",
  important: ".wcftst-2025",
  corePlugins: {
    preflight: false,
  },
  theme: {
