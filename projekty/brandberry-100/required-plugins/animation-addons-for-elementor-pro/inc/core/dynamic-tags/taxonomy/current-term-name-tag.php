 ...
 */
class Current_Term_Name_Tag extends Tag_Base {
	use \WCFAddonsPro\Base\Tags\CustomPostIdTrait;
	/**
	 * Unique tag name.
	 *
	 * @return string
	...
	public function get_title() {
		return esc_html__( 'Current Term Name', 'animation-addons-for-elementor-pro' );
	}
