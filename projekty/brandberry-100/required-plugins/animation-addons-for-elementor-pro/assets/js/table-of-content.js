    ...
    getHeadings: function () {
      ...
      return this.elements.$pageContainer.find(tags).not(selectors.headerTitle).filter((index, heading) => {
        ScrollTrigger.create({
          ...
          onEnter: () => heading.previousSibling?.id ? this.setActiveLink(heading.previousSibling?.id) : '',
          onLeaveBack: () => heading.previousSibling?.id ? this.setActiveLink(heading.previousSibling?.id) : ''
        });
