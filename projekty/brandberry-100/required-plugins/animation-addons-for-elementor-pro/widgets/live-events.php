...
use WCFAddonsPro\AAE_Post_Handler_Trait;
 ...
 * @since 1.0.0
 */
class Live_Events extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Live Events', 'animation-addons-for-elementor-pro' );
	}
	...
	public function get_script_depends() {
		return [ 'wcf--posts', 'advanced--adv-posts-pro' ];
	}
	...
	protected function style_post_timeline() {
		...
		$this->add_control(
			'tl_dot_color',
			[
				'label'     => esc_html__( 'Dot Color', 'animation-addons-for-elementor-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .live-event-ago::before' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'tl_dot_size',
			[
				'label'      => esc_html__( 'Dot Size', 'animation-addons-for-elementor-pro' ),
				...
				'selectors'  => [
					'{{WRAPPER}} .live-event-ago::before' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'tl_dot_otl_color',
			[
				'label'     => esc_html__( 'Outline Color', 'animation-addons-for-elementor-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .live-event-ago::before' => 'outline-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'tl_dot_otl_width',
			[
				'label'      => esc_html__( 'Outline Width', 'animation-addons-for-elementor-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .live-event-ago::before' => 'outline-width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .live-event-ago::before' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'tl_line',
			[
				'label'     => esc_html__( 'Line Color', 'animation-addons-for-elementor-pro' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_responsive_control(
			'tl_line_width',
			[
				'label'      => esc_html__( 'Line Width', 'animation-addons-for-elementor-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'tl_date_heading',
			[
				'label'     => esc_html__( 'Time Ago', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .live-event-ago' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				'name'     => 'tl_date_typo',
				'selector' => '{{WRAPPER}} .live-event-ago',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .live-event-ago span' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .live-event-ago' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .live-event-ago' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'location' => esc_html__( 'Location', 'animation-addons-for-elementor-pro' ),
	...
	protected function render() {
		...
		while ( $query->have_posts() ) {
			...
			if ( 'layout-normal' === $settings['post_layout'] ) {
				...
				$this->render_post_layout_side_overlay( $settings );
			}
		}
	...
	protected function render_post_layout_normal( $settings ) {
        ...
        <article <?php post_class( $post_classes ); ?>>
            <div class="live-event-ago">
				<?php echo $this->live_events_ago(); ?>
                <span></span>
            </div>
			<?php
	...
	protected function render_post_layout_side_overlay( $settings ) {
		$post_classes = [ 'wcf-post' ];
		?>
        <div class="live-event-ago">
			<?php echo $this->live_events_ago(); ?>
        ...
        <article <?php post_class( $post_classes ); ?>>
            ...
            <div class="content">
				...
				foreach ( $settings['post_layout_one'] as $item ) {
					...
					if ( 'meta' === $item['post_item'] && 'yes' === $settings['show_meta'] ) {
						$this->render_meta_data();
					}

					if ( 'read_more' === $item['post_item'] && 'yes' === $settings['show_read_more'] ) {
						$this->render_read_more();
					}
				}
				?>
	...
	public function live_events_ago() {
