...
class Mega_Menu extends Widget_Nested_Base {
	...
	public function get_title() {
		return esc_html__( 'Mega Menu', 'animation-addons-for-elementor-pro' );
	}

	public function get_icon() {
		return 'wcf eicon-mega-menu';
	}
	...
	protected function get_default_children_elements() {
		return [
			[
				'elType' => 'container',
				'settings' => [
					'_title' => __( 'Item #1', 'animation-addons-for-elementor-pro' ),
				],
			],
			[
				'elType' => 'container',
				'settings' => [
					'_title' => __( 'Item #2', 'animation-addons-for-elementor-pro' ),
				],
			],
			[
				'elType' => 'container',
				'settings' => [
					'_title' => __( 'Item #3', 'animation-addons-for-elementor-pro' ),
				],
			],
		];
	}
	...
	protected function get_default_children_title() {
		return esc_html__( 'Item #%d', 'animation-addons-for-elementor-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'menu_name',
			[
				'label' => esc_html__( 'Menu Name', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => esc_html__( 'Menu', 'animation-addons-for-elementor-pro' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Paste URL or type', 'animation-addons-for-elementor-pro' ),
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Dropdown Content', 'animation-addons-for-elementor-pro' ),
				...
				'default' => 'no',
				'description' => esc_html__( 'Click on the menu item to edit its dropdown content.', 'animation-addons-for-elementor-pro' ),
				'frontend_available' => true,
			]
		);
		...
		$repeater->add_control(
			'element_id',
			[
				'label' => esc_html__( 'CSS ID', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'dynamic' => [
					'active' => true,
				...
				'title' => esc_html__( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			'menu_items',
			[
				'label' => esc_html__( 'Menu Items', 'animation-addons-for-elementor-pro' ),
				'type' => Control_Nested_Repeater::CONTROL_TYPE,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'item_title' => esc_html__( 'Item #1', 'animation-addons-for-elementor-pro' ),
					],
					[
						'item_title' => esc_html__( 'Item #2', 'animation-addons-for-elementor-pro' ),
					],
					[
						'item_title' => esc_html__( 'Item #3', 'animation-addons-for-elementor-pro' ),
					],
				],
		...
		$this->add_control(
			'content_width',
			[
				'label' => esc_html__( 'Content Width', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'full_width',
				'separator' => 'before',
				'options' => [
					'full_width' => esc_html__( 'Full Width', 'animation-addons-for-elementor-pro' ),
					'fit_to_content' => esc_html__( 'Fit To Content', 'animation-addons-for-elementor-pro' ),
				],
				'prefix_class' => 'e-',
				'frontend_available' => true,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Content Horizontal Position', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			'item_layout',
			[
				'label' => esc_html__( 'Item Layout', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'horizontal',
				'options' => [
					'horizontal' => esc_html__( 'Horizontal', 'animation-addons-for-elementor-pro' ),
					'dropdown' => esc_html__( 'Dropdown', 'animation-addons-for-elementor-pro' ),
				],
		...
		$this->add_responsive_control( 'item_position_horizontal', [
			'label' => esc_html__( 'Item Position', 'animation-addons-for-elementor-pro' ),
			'type' => Controls_Manager::CHOOSE,
			'options' => [
				'start' => [
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Dropdown Indicator', 'animation-addons-for-elementor-pro' ),
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section( 'section_dropdown_effect', [
			'label' => esc_html__( 'Dropdown Effect', 'animation-addons-for-elementor-pro' ),
		] );

		$this->add_control(
			'open_on',
			[
				'label' => esc_html__( 'Open On', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'hover',
				'options' => [
		...
		$this->add_control(
			...
			[
				...
				'raw' => esc_html__( 'The hover effect is inactive while editing. Preview your page to see it in action.', 'animation-addons-for-elementor-pro' ),
		...
		$this->start_controls_section( 'menu_toggle_section', [
			'label' => esc_html__( 'Menu Toggle', 'animation-addons-for-elementor-pro' ),
		] );
		...
		$this->add_control(
			...
			[
				...
				'skin_settings' => [
					'inline' => [
						'none' => [
							'label' => esc_html__( 'Default', 'animation-addons-for-elementor-pro' ),
							'icon' => 'eicon-menu-bar',
						],
						'icon' => [
							'icon' => 'eicon-star',
		...
		$this->add_responsive_control( 'menu_item_title_space_between', [
			'label' => esc_html__( 'Space between Items', 'animation-addons-for-elementor-pro' ),
			'type' => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control( 'menu_item_title_distance_from_content', [
			'label' => esc_html__( 'Distance from content', 'animation-addons-for-elementor-pro' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
			'range' => [
				'px' => [
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					'text_shadow_type' => [
						'label' => esc_html_x( 'Shadow', 'Text Shadow Control', 'animation-addons-for-elementor-pro' ),
					],
				],
			]
		);
		...
		$this->add_control(
			'menu_divider',
			[
				'label' => esc_html__( 'Divider', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'animation-addons-for-elementor-pro' ),
				'label_on' => esc_html__( 'On', 'animation-addons-for-elementor-pro' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'solid' => esc_html__( 'Solid', 'animation-addons-for-elementor-pro' ),
					'double' => esc_html__( 'Double', 'animation-addons-for-elementor-pro' ),
					'dotted' => esc_html__( 'Dotted', 'animation-addons-for-elementor-pro' ),
					'dashed' => esc_html__( 'Dashed', 'animation-addons-for-elementor-pro' ),
				],
				'default' => 'solid',
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Transition Duration', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 's', 'ms', 'custom' ],
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Toggle Icon', 'animation-addons-for-elementor-pro' ),
			]
		);
		...
		$this->add_responsive_control( 'menu_toggle_icon_distance_from_dropdown', [
			'label' => esc_html__( 'Distance from dropdown', 'animation-addons-for-elementor-pro' ),
			'type' => Controls_Manager::SLIDER,
			'size_units' => [ 'px', 'em', 'rem', 'custom' ],
			'range' => [
				'px' => [
		...
		$this->start_controls_section( 'section_dropdown_menu_style', [
			'label' => esc_html__( 'Dropdown Menu', 'animation-addons-for-elementor-pro' ),
			'tab' => Controls_Manager::TAB_STYLE,
		] );
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => esc_html__( 'Styles apply to items when the menu switches to dropdown layout', 'animation-addons-for-elementor-pro' ),
				'content_classes' => 'elementor-control-field-description',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Dropdown Box', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => esc_html__( 'Style the dropdown box that contains menu items.', 'animation-addons-for-elementor-pro' ),
				'content_classes' => 'elementor-control-field-description',
			]
		);
	...
	protected function render_menu_toggle( $settings ) {
		...
		$this->add_render_attribute( 'menu-toggle', [
			...
			'aria-label' => esc_attr__( 'Menu Toggle', 'animation-addons-for-elementor-pro' ),
		] );
		...
		?>
			...
			const menuToggleKey = 'e-n-menu-toggle-' + elementUid,
				...
				view.addRenderAttribute( menuToggleKey, {
					...
					'aria-label': '<?php echo esc_attr__( 'Menu Toggle', 'animation-addons-for-elementor-pro' ); ?>',
				} );
			#>
					...
					<?php if ( $has_dropdown_content ) { ?>
						<button <?php echo wp_kses_post( $this->get_render_attribute_string( $key . '_link' ) ); ?> >
							<span class="e-n-menu-dropdown-icon-opened">
								...
								<span class="elementor-screen-only"><?php echo sprintf( esc_html__( 'Close %s', 'animation-addons-for-elementor-pro' ), $item['item_title'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
							</span>
							<span class="e-n-menu-dropdown-icon-closed">
								<?php echo $icon_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
								<span class="elementor-screen-only"><?php echo sprintf( esc_html__( 'Open %s', 'animation-addons-for-elementor-pro' ), $item['item_title'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
							</span>
						</button>
					<?php } ?>
				</div>
							...
							<# if ( hasDropdownContent ) { #>
								<button {{{ view.getRenderAttributeString( menuItemDropdownIconKey ) }}}>
									<span class="e-n-menu-dropdown-icon-opened">
										...
										<span class="elementor-screen-only"><?php echo esc_html__( 'Close', 'animation-addons-for-elementor-pro' ); ?> {{{ item.item_title }}}</span>
									</span>
									<span class="e-n-menu-dropdown-icon-closed">
										{{{ menuItemIcon.value }}}
										<span class="elementor-screen-only"><?php echo esc_html__( 'Open', 'animation-addons-for-elementor-pro' ); ?> {{{ item.item_title }}}</span>
									</span>
								</button>
							<# } #>
						</div>
		...
		<li class="e-n-menu-item">
			<div {{{ view.getRenderAttributeString( menuItemWrapperKey ) }}}>
				...
				<button {{{ view.getRenderAttributeString( menuItemDropdownIconKey ) }}}>
						<span class="e-n-menu-dropdown-icon-opened">
							{{{ menuItemIconActive.value }}}
							<span class="elementor-screen-only"><?php echo esc_html__( 'Close', 'animation-addons-for-elementor-pro' ); ?> {{{ data.item_title }}}</span>
						</span>
					<span class="e-n-menu-dropdown-icon-closed">
							{{{ menuItemIcon.value }}}
							<span class="elementor-screen-only"><?php echo esc_html__( 'Open', 'animation-addons-for-elementor-pro' ); ?> {{{ data.item_title }}}</span>
						</span>
				</button>
				<# } #>
			</div>
