...
class Post_Rating extends Widget_Base {
	...
	protected function register_rating_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'list'           => esc_html__( 'List View', 'animation-addons-for-elementor-pro' ),
	...
	protected function style_average_rating() {
		$this->start_controls_section(
			'style_avg_rating',
			[
				'label'     => esc_html__( 'Average Rating', 'animation-addons-for-elementor-pro' ),
				'tab'       => Controls_Manager::TAB_STYLE,
				'condition' => [ 'rating_layout' => 'average-rating' ],
			]
		);
                    ...
                    <div class="content">
                        ...
                        <div class="stars">
							...
							for ( $i = 1; $i <= 5; $i ++ ) {
								...
								?>
                                <span class="star"
                                      style="color:<?php echo esc_attr( $color ); ?>; fill:<?php echo esc_attr( $color ); ?>;">
                                    <?php Icons_Manager::render_icon( $settings['rating_icon'], [ 'aria-hidden' => 'true' ] ); ?>
                                </span>
								<?php
							}
