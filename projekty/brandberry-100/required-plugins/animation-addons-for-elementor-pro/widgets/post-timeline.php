...
class Post_Timeline extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Timeline', 'animation-addons-for-elementor-pro' );
	}
	...
	protected function style_post_timeline() {
		...
		$this->add_control(
			'tl_month_heading',
			[
				'label'     => esc_html__( 'Month', 'animation-addons-for-elementor-pro' ),
	...
	protected function register_layout_style_controls() {
		...
		$this->add_control(
			'tl_layout_shadow',
			[
				'label' => esc_html__( 'Layout Shadow', 'animation-addons-for-elementor-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
