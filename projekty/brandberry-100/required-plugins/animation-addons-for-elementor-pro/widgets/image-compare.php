...
class Image_Compare extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Image Comparison', 'animation-addons-for-elementor-pro' );
	}
	...
	public function get_script_depends() {
		return [ 'wcf--image-compare', 'Draggable' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'before_image',
			[
				'label'   => esc_html__( 'Before Image', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			'after_image',
			[
				'label'   => esc_html__( 'After Image', 'animation-addons-for-elementor-pro' ),
				'type'    => Controls_Manager::MEDIA,
				'default' => [
					'url' => Utils::get_placeholder_image_src(),
				],
		...
		$this->add_control(
			'show_caption',
			[
				'label'        => esc_html__( 'Show Caption', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			'before_caption',
			[
				'label'       => esc_html__( 'Before Caption', 'animation-addons-for-elementor-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'Before Caption', 'animation-addons-for-elementor-pro' ),
				'placeholder' => esc_html__( 'Type your caption here', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			'after_caption',
			[
				'label'       => esc_html__( 'After Caption', 'animation-addons-for-elementor-pro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( 'After Caption', 'animation-addons-for-elementor-pro' ),
				'placeholder' => esc_html__( 'Type your caption here', 'animation-addons-for-elementor-pro' ),
				'condition'   => [ 'show_caption' => 'yes' ],
			]
		);
		...
		$this->add_control(
			'show_btn',
			[
				'label'        => esc_html__( 'Show Button', 'animation-addons-for-elementor-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'label_on'     => esc_html__( 'Show', 'animation-addons-for-elementor-pro' ),
				'label_off'    => esc_html__( 'Hide', 'animation-addons-for-elementor-pro' ),
				'return_value' => 'yes',
		...
		$this->start_controls_section(
			'style_handle',
			[
				'label' => esc_html__( 'Handler', 'animation-addons-for-elementor-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'circle_heading',
			[
				'label' => esc_html__( 'Circle', 'animation-addons-for-elementor-pro' ),
		...
		$this->start_controls_section(
			'style_caption',
			[
				'label' => esc_html__( 'Caption', 'animation-addons-for-elementor-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => ['show_caption' => 'yes'],
			]
		);
        ...
        <div <?php $this->print_render_attribute_string( 'wrapper' ); ?>>
			...
			<?php if ( 'yes' === $settings['show_btn'] ) { ?>
                <div class="cmp-btn-wrapper">
                    <button class="cmp-btn btn-expand-left"><?php echo esc_html__('Expand left', 'animation-addons-for-elementor-pro'); ?></button>
                    <button class="cmp-btn btn-expand-center"><?php echo esc_html__('50/50', 'animation-addons-for-elementor-pro'); ?></button>
                    <button class="cmp-btn btn-expand-right"><?php echo esc_html__('Expand right', 'animation-addons-for-elementor-pro'); ?></button>
                </div>
			<?php } ?>
        </div>
