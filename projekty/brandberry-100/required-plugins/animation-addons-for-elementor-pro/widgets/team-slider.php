...
class Team_Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Team Slider', 'animation-addons-for-elementor-pro' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Team Slider', 'animation-addons-for-elementor-pro' ),
			]
		);
		...
		$this->add_control(
			'slider_style',
			[
				'label'   => esc_html__( 'Slider Style', 'animation-addons-for-elementor-pro' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'default'     => esc_html__( 'Jeanel Christina', 'animation-addons-for-elementor-pro' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type'        => Controls_Manager::TEXT,
				'label_block' => true,
				'default'     => esc_html__( 'Senior Developer', 'animation-addons-for-elementor-pro' ),
			]
		);
		...
		$repeater->add_control(
			'social_icon_01',
			[
				'label'            => esc_html__( 'Social One', 'animation-addons-for-elementor-pro' ),
		...
		$repeater->add_control(
			'social_icon_02',
			[
				'label'            => esc_html__( 'Social Two', 'animation-addons-for-elementor-pro' ),
				'type'             => Controls_Manager::ICONS,
				'skin'				=> 'inline',
				'label_block'		=> false,
				'fa4compatibility' => 'social',
		...
		$repeater->add_control(
			'social_icon_03',
			[
				'label'            => esc_html__( 'Social Three', 'animation-addons-for-elementor-pro' ),
				'type'             => Controls_Manager::ICONS,
				'skin'				=> 'inline',
				'label_block'		=> false,
				'fa4compatibility' => 'social',
		...
		$repeater->add_control(
			'social_icon_04',
			[
				'label'            => esc_html__( 'Social Four', 'animation-addons-for-elementor-pro' ),
				'type'             => Controls_Manager::ICONS,
				'skin'				=> 'inline',
				'label_block'		=> false,
				'fa4compatibility' => 'social',
		...
		$this->add_control(
			'team_slides',
			[
				'label'   => esc_html__( 'Team Slides', 'animation-addons-for-elementor-pro' ),
		...
		$this->start_controls_section(
			'style_social',
			[
				'label' => esc_html__( 'Social Media', 'animation-addons-for-elementor-pro' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'helo_show_social',
			[
				'label'     => esc_html__( 'Show Social', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_responsive_control(
			'social_gap_buttom',
			[
				'label'      => esc_html__( 'Gap Bottom', 'animation-addons-for-elementor-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem' ],
				'range'      => [
					'px' => [
	...
	private function slider_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'coverflow' => esc_html__( 'CoderFlow', 'animation-addons-for-elementor-pro' ),
				],
			]
		);
		...
		$this->add_control(
			'navigation',
			[
				'label'     => esc_html__( 'Slider Controls', 'animation-addons-for-elementor-pro' ),
				'type'      => Controls_Manager::SELECT,
				'separator' => 'before',
				'default'   => 'both',
				'options'   => [
					'both'   => esc_html__( 'Both', 'animation-addons-for-elementor-pro' ),
					'arrows' => esc_html__( 'Navigation', 'animation-addons-for-elementor-pro' ),
					'dots'   => esc_html__( 'Pagination', 'animation-addons-for-elementor-pro' ),
		...
		$this->add_control(
			...
			[
				...
				'default'   => 'bullets',
				'options'   => [
					'bullets'     => esc_html__( 'Dots', 'animation-addons-for-elementor-pro' ),
	...
	private function slider_navigation_style_controls() {
		...
		$this->add_responsive_control(
			'pagination_btm',
			[
				'label'      => esc_html__( 'Position Bottom', 'animation-addons-for-elementor-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%', 'em', 'rem', 'custom' ],
				'range'      => [
					'px' => [
		...
		$this->add_control(
			'pagination_active',
			[
				'label'     => esc_html__( 'Pagination Active', 'animation-addons-for-elementor-pro' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
