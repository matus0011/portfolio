 ...
 * @class   Redux_Extenzeyna_Custom_Fonts
 * @version 4.4.2
 */

defined('ABSPATH') || exit;

if (!class_exists('Redux_Extenzeyna_Custom_Fonts')) {

	/**
	 * Class Redux_Extenzeyna_Custom_Fonts
	 */
	class Redux_Extenzeyna_Custom_Fonts extends Redux_Extenzeyna_Abstract
	{
...
class_alias('Redux_Extenzeyna_Custom_Fonts', 'ReduxFramework_Extenzeyna_custom_fonts');
