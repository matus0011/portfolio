 ...
 * @since 1.1.0
 */
class PeWEBGLCarousel extends Widget_Base
{
    ...
    {
        return __('Showcase WEBGL Carousel', 'pe-core');
    }
    ...
    {
        return 'eicon-slider-3d pe-widget';
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'show_progress',
            [
                'label' => __('Carousel Progress', 'pe-core '),
        ...
        $this->add_control(
            'show_fraction',
            [
                'label' => __('Carousel Fraction', 'pe-core '),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'pe-core '),
                'label_off' => __('Hide', 'pe-core '),
                'return_value' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'type' => \Elementor\Controls_Manager::RAW_HTML,
                'raw' => "<div class='elementor-panel-notice elementor-panel-alert elementor-panel-alert-info'>	
                Please make sure that your project images use the same aspect ratio specified here (3:4 by default). Otherwise, since the WebGL renderer does not support image-fit properties, the images may appear distorted. </div>",
        ...
        objectAbsolutePositioning($this, '.pe--webgl--carousel--wrapper', 'titles', 'Titles');
        objectAbsolutePositioning($this, '.pe--webgl--carousel--nav', 'controls', 'Controls');
    ...
    protected function render()
    {
        ...
        <div class="pe--webgl--carousel" data-settings="">

            <div class="pe--webgl--carousel--wrapper">
                <?php
            ...
            <div class="pe--webgl--carousel--nav">

                <div class="pwc--carousel--nav">

                    <?php if ($settings['show_fraction'] === 'yes') { ?>
                        <span class="pwc--current">
                            <span class="pwc--current--wrapper">
                                <?php
                                for ($x = 1; $x <= $loop->post_count; $x++) {
                                    echo '<span>' . sprintf('%02d', $x) . '</span>';
                                }
                                ?>
                            </span>
                        </span>
                    ...
                    <?php if ($settings['show_progress'] === 'yes') { ?>
                        <span class="pwc--progress"><span></span></span>
                    <?php } ?>
                    <?php if ($settings['show_fraction'] === 'yes') { ?>
                        <span class="pwc--total"><?php echo esc_html($loop->post_count) ?></span>
                    <?php } ?>
                </div>
