 ...
 * @class   Redux_Extenzeyna_Icon_Select
 * @version 4.4.2
 */
...
// Don't duplicate me!
if ( ! class_exists( 'Redux_Extenzeyna_Icon_Select' ) ) {
	 ...
	 * @since       3.1.6
	 */
	class Redux_Extenzeyna_Icon_Select extends Redux_Extenzeyna_Abstract {
		...
		/**
		 * ReduxFramework_Extenzeyna_Icon_Select constructor.
		 *
...
class_alias( 'Redux_Extenzeyna_Icon_Select', 'ReduxFramework_extenzeyna_icon_select' );
